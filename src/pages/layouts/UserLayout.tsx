...
const UserLayout = () => {
  ...
  useEffect(() => {
    ...
    const handlePostInteraction = ({ recipientId, message }: { recipientId: string; senderId: string; senderName: string; communityId: string; postId: string; message: string }) => {
    ...
    const handleQuestionedInteraction = ({ recipientRole, message }: { recipientRole: string; senderId: string; senderName: string; communityId: string; message: string }) => {
    ...
    const handleReceivedMessage = ({ message, recipientId }: { message: string; senderId: string; recipientId: string }) => {
