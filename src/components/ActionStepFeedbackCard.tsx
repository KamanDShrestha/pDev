...
const JourneyFeedbackCard = ({ feedback, feedbackId, userId, journeyId, userRole }: ActionStepFeedbackCardProps) => {
  ...
  return (
    <Card className="max-w-[550px] ">
      ...
      <CardContent className="flex flex-col gap-3">
        ...
        <div>
          <>
            <Heading className="m-0 text-lg">Feedbacks for the action steps:</Heading>
            <div>
              <div>
                <div>
